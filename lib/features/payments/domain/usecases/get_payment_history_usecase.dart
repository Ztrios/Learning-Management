...
class GetPaymentHistoryUseCase extends UseCase<PaymentHistoryEntity, Map<String,dynamic>>{
  @override
  Future<Either<Failure, PaymentHistoryEntity>> call({Map<String, dynamic>? params}) async =>
      await sl<PaymentsRepositories>().getPaymentHistory(query: params ?? {});
}