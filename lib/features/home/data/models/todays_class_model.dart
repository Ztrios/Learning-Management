...
class TodaysClassModel {
  ...
  factory TodaysClassModel.fromRawJson(String str) => TodaysClassModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TodaysClassModel.fromJson(Map<String, dynamic> json) => TodaysClassModel(
  ...
  TodaysClassEntity toEntity()=> TodaysClassEntity(
    statusCode: statusCode,
    message: message,
    classData: classData,
  );
